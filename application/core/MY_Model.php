...
class MY_Model extends CI_Model {
	...
	/**
	 * Initialise the model, tie into the CodeIgniter superobject and try our best to guess the table name.
	 */
	 ...
	 * @param  [type] $primary_value [description]
	 ...
	 * @param  [type]  $primary_values  [description]
	 * @param  [type]  $data            [description]
	 * @param  boolean $skip_validation [description]
	 * @return [type]                   [description]
	 */
